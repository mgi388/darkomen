...
impl<R: Read + Seek> Decoder<R> {
    ...
    fn read_instance(&mut self, buf: &[u8]) -> Result<Instance, DecodeError> {
        Ok(Instance {
            ...
            exclude_from_terrain: i32::from_le_bytes(buf[12..16].try_into().unwrap()) != 0,
            ...
            attackable: i32::from_le_bytes(buf[72..76].try_into().unwrap()) != 0,
            ...
            burnable: i32::from_le_bytes(buf[92..96].try_into().unwrap()) != 0,
            spatial_sound_effect_code: u32::from_le_bytes(buf[96..100].try_into().unwrap()),
            attachment_code: u32::from_le_bytes(buf[100..104].try_into().unwrap()),
            locked: i32::from_le_bytes(buf[104..108].try_into().unwrap()),
            exclude_from_terrain_shadow: i32::from_le_bytes(buf[108..112].try_into().unwrap()) != 0,
            exclude_from_walk: i32::from_le_bytes(buf[112..116].try_into().unwrap()) != 0,
